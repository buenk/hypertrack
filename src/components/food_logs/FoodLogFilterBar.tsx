...
import {
  useFoodLogsFilters,
  FoodLogsFilters,
} from "@/hooks/useFoodLogsFilters";
import { useIsMobile } from "@/hooks/use-mobile";
import { Button } from "../ui/button";
import { SlidersHorizontal } from "lucide-react";

interface FoodLogFilterBarProps {
  filters: FoodLogsFilters;
}

export function FoodLogFilterBar({ filters }: FoodLogFilterBarProps) {
  ...
  const { setFilters } = useFoodLogsFilters();
          ...
          {isMobile ? (
            <div className="grid grid-cols-6 gap-4 w-full items-center">
              <div className="col-span-5">
                <Input
                  id="search"
                  placeholder="Search logs by food name..."
                  value={search}
